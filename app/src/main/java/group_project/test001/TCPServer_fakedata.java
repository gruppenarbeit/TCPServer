...
public class TCPServer_fakedata {
    ...
    byte[] battery_charge = {90};
    byte[] battery_voltage = {0, 10};
    byte[] sequence_number = {77, 77, 77, 77};
    ...
    private byte[] device_name()
    {
        ...
        byte[] get_zeros = reserviert(64 - string_device_name.length);
    ...
    private byte[] reserviert(int repeat) {
    ...
    private byte[] fake_packet(byte[] received_from_Remo) {
        ...
        try {
            ...
            if (headerString.endsWith("DRDY")) {
                ...
                inStreamBuffer.write(reserviert(12));
            ...
            //done
                ...
                inStreamBuffer.write(reserviert(16));
                inStreamBuffer.write(battery_charge);
                inStreamBuffer.write(battery_voltage);
                inStreamBuffer.write("PEND".getBytes());
            ...
            //done
                ...
                inStreamBuffer.write(raw_data);
                inStreamBuffer.write(reserviert(16));
                inStreamBuffer.write(reserviert(32)); //GPS
                inStreamBuffer.write(battery_charge);
                inStreamBuffer.write(battery_voltage);
                inStreamBuffer.write("PEND".getBytes());
            }
